...
pe "kubectl set image deployments.app/simple-app simple-app=danielives/simple-app:v2"
...
pe "kubectl set image deployments.app/simple-app simple-app=danielives/simple-app:v3 --record"
